...
class DlistViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let values = [ "Bar","Cafe","Restaurant", "Bank","Night Club","Museum", "Beuty Salon","Pharmacy","Hospital","Bus Station","Gas Station","University","Police","Church","Cemetery","Park","Gym"]
